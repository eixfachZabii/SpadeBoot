...
public class HandEvaluationServiceTest {
    ...
    public void testRoyalFlushVsFourOfAKind() {
        ...
        alice.getHand().addCard(createCard(Suit.SPADES, c_Rank.ACE));
        alice.getHand().addCard(createCard(Suit.SPADES, c_Rank.KING));

        // Bob's cards - Four of a Kind
        bob.getHand().addCard(createCard(Suit.HEARTS, c_Rank.FOUR));
        bob.getHand().addCard(createCard(Suit.CLUBS, c_Rank.FOUR));

        // Community cards
        List<Card> communityCards = new ArrayList<>();
        communityCards.add(createCard(Suit.SPADES, c_Rank.QUEEN));
        communityCards.add(createCard(Suit.SPADES, c_Rank.JACK));
        communityCards.add(createCard(Suit.SPADES, c_Rank.TEN));
        communityCards.add(createCard(Suit.DIAMONDS, c_Rank.FOUR));
        communityCards.add(createCard(Suit.SPADES, c_Rank.FOUR));

        // Mock hand results
        HandResult aliceHandResult = new HandResult(HandRank.ROYAL_FLUSH,
                List.of(
                        createCard(Suit.SPADES, c_Rank.ACE),
                        createCard(Suit.SPADES, c_Rank.KING),
                        createCard(Suit.SPADES, c_Rank.QUEEN),
                        createCard(Suit.SPADES, c_Rank.JACK),
                        createCard(Suit.SPADES, c_Rank.TEN)
                ));

        HandResult bobHandResult = new HandResult(HandRank.FOUR_OF_A_KIND,
                List.of(
                        createCard(Suit.DIAMONDS, c_Rank.FOUR),
                        createCard(Suit.SPADES, c_Rank.FOUR),
                        createCard(Suit.HEARTS, c_Rank.FOUR),
                        createCard(Suit.CLUBS, c_Rank.FOUR),
                        createCard(Suit.DIAMONDS, c_Rank.ACE)
                ));
